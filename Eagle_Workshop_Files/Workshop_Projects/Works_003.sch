...
<symbol name="VPP" library_version="1">
<circle x="0" y="1.27" radius="1.27" width="0.254" layer="94"/>
<text x="-1.905" y="3.175" size="1.778" layer="96">&gt;VALUE</text>
...
<deviceset name="VPP" prefix="SUPPLY" library_version="1">
<description>&lt;b&gt;SUPPLY SYMBOL&lt;/b&gt;</description>
<gates>
...
<deviceset name="VSS" prefix="SUPPLY" library_version="1">
<description>&lt;b&gt;SUPPLY SYMBOL&lt;/b&gt;</description>
<gates>
...
<devicesets>
<deviceset name="BATTERY" prefix="BAT" uservalue="yes" library_version="1">
...
<part name="BAT1" library="special" library_urn="urn:adsk.eagle:library:367" deviceset="BATTERY" device=""/>
<part name="BAT2" library="adafruit" deviceset="CR1220" device="SMT"/>
</parts>
<sheets>
<sheet>
<plain>
<text x="2.54" y="175.26" size="1.778" layer="91">WORKS_003
VOLTAGE REGULATORS, POWER SOURCE, AND VOLTAGE NODES
THIS PAGES SHOWS WHAT ARE VOLTAGE REGULATORS ARE, ALONG WITH SYMBOLS FOR POWER SOURCE AND VOLTAGE NODES.</text>
<text x="2.54" y="160.02" size="1.778" layer="91">POWER MANAGEMENT INTEGRATED CIRCUIT,
OR PMIC, IS TYPE OF POWER MANAGEMENT
IC WHICH WILL REGULATE VOLTAGE BY EITHER
STEPPING VOLTAGE UP/DOWN.</text>
<text x="2.54" y="144.78" size="1.778" layer="91">TWO MAJOR TYPES OF PMIC EXISTS; LINEAR
AND SWITCHING.
LINEAR PROVIDES VOLTAGE OUTPUT IN LINEAR
CHARACTERISTIC; THAT IS, WHEN LOOKED AT
OUTPUT GRAPH, IT IS ALMOST LINEAR.</text>
<text x="2.54" y="116.84" size="1.778" layer="91">SWITCHING USES TWO DIFFERENT TOPOLOGY
FOR VOLTAGE OUTPUT; BOOST OR BUCK. BOOST
SIMPLY STEPS UP THE INPUT VOLTAGE TO
OUTPUT VOLTAGE, WHILE STEPPING DOWN THE
CURRENT OUTPUT. BUCK STEPS DOWN THE
INPUT VOLTAGE TO OUTPUT VOLTAGE, WHILE
STEPPING UP THE CURRENT OUTPUT. WHICH
MEANS SWITCHING PMIC CAN REACT TO VARIOUS 
VOLTAGE INPUT WHILE HAVING FIXED
VOLTAGE OUTPUT</text>
<text x="2.54" y="96.52" size="1.778" layer="91">AFTER CHOOSING THE CONVERTING TOPOLOGY,
TWO TYPES OF OUTPUTS ARE AVAILABLE; FIXED
OR VARIOUS.
FIXED OUTPUT VOLTAGE MEANS OUTPUT IS FIXED
AND WILL NOT CHANGE. VARIOUS OUTPUT
MEANS OUTPUT VOLTAGE CAN BE ADJUSTED BY
MODIFYING THE CIRCUITRY AROUND THE PMIC.</text>
<text x="2.54" y="71.12" size="1.778" layer="91">IN SCHEMATICS, EITHER 3 OR 4 PINS WILL BE
SHOWN IN THE PMIC. IN IS WHERE INPUT VOLTAGE
COMES IN, WHILE OUT(S) IS WHERE OUTPUT
VOLTAGE COMES OUT. IF VOLTAGE OUTPUT IS
FIXED, ADJ PIN ACTS AS GROUND PIN, WHILE
FOR VARIOUS OUTPUT, ADJ PIN IS USED TO
MODIFY THE OUTPUT VOLTAGE. TYPICALLY, VOLTAGE
DIVIDER TECHNIQUE IS USED TO GIVE FEEDBACK
TO ADJ PIN.</text>
<text x="2.54" y="33.02" size="1.778" layer="91">VARIABLE OUTPUT</text>
<text x="43.18" y="33.02" size="1.778" layer="91">FIXED OUTPUT</text>
<text x="2.54" y="15.24" size="1.778" layer="91">MANUFACTURES BUILDS BOTH VARIOUS/FIXED
OUTPUT MODEL FOR SAME TOPOLOGY. IF THAT
IS THE CASE, YOU WILL SEE ADJ PIN REGARDLESS
OF WHAT TYPE IT IS. SIMPLY IGNORE THE ADJ
PIN AND ASSUME IT AS GROUND PIN IF YOU ARE
USING FIXED VERSION</text>
<wire x1="0" y1="172.72" x2="76.2" y2="172.72" width="0.1524" layer="94"/>
<wire x1="76.2" y1="172.72" x2="149.86" y2="172.72" width="0.1524" layer="94"/>
<wire x1="149.86" y1="172.72" x2="248.92" y2="172.72" width="0.1524" layer="94"/>
<wire x1="76.2" y1="0" x2="76.2" y2="68.58" width="0.1524" layer="94"/>
<text x="78.74" y="162.56" size="1.778" layer="91">VOLTAGE NODES HAVE DIFFERENT NAMES AND
DIFFERENT SYMBOLS, DEPENDING ON WHAT
THEY ARE USED FOR.</text>
<text x="78.74" y="139.7" size="1.778" layer="91">POSITIVE SYMBOLS</text>
<text x="111.76" y="139.7" size="1.778" layer="91">GROUND/NEGATIVE SYMBOLS</text>
<text x="111.76" y="114.3" size="1.778" layer="91">GROUND/NEGATIVE SYMBOLS</text>
<text x="78.74" y="114.3" size="1.778" layer="91">POSITIVE SYMBOLS</text>
<text x="78.74" y="132.08" size="1.778" layer="91">THESE SYMBOLS ARE USED ALONG WITH IC</text>
<wire x1="76.2" y1="68.58" x2="76.2" y2="111.76" width="0.1524" layer="94"/>
<wire x1="76.2" y1="111.76" x2="76.2" y2="172.72" width="0.1524" layer="94"/>
<wire x1="76.2" y1="111.76" x2="149.86" y2="111.76" width="0.1524" layer="94"/>
<wire x1="149.86" y1="111.76" x2="149.86" y2="172.72" width="0.1524" layer="94"/>
<text x="78.74" y="99.06" size="1.778" layer="91">SINCE ONLY AVAILABLE POWER SOURCE
SYMBOL FOR EAGLE CAD ARE BATTERIES, WE
WILL LOOK AT BOTH REGULAR BATTERY SYMBOL
AND COIN CELL BATTERY SYMBOL</text>
<text x="78.74" y="71.12" size="1.778" layer="91">COIN CELL HOLDERS HAVE TWO POSITIVE PINS;
HENCE WHY THERE ARE TWO PINS ON COIN CELL
SYMBOL</text>
<text x="93.472" y="85.344" size="1.778" layer="91">&lt;- COMMON</text>
<text x="124.968" y="85.344" size="1.778" layer="91">&lt;-COIN CELL</text>
<wire x1="149.86" y1="111.76" x2="149.86" y2="68.58" width="0.1524" layer="94"/>
<wire x1="149.86" y1="68.58" x2="76.2" y2="68.58" width="0.1524" layer="94"/>
</plain>
<instances>
...
<instance part="R2" gate="G$1" x="25.4" y="45.72" rot="R270"/>
<instance part="GND1" gate="1" x="12.7" y="38.1"/>
<instance part="GND2" gate="1" x="50.8" y="38.1"/>
<instance part="+3V1" gate="G$1" x="81.28" y="157.48"/>
<instance part="P+1" gate="1" x="91.44" y="157.48"/>
<instance part="GND3" gate="1" x="114.3" y="154.94"/>
...
<instance part="SUPPLY4" gate="G$1" x="86.36" y="124.46"/>
<instance part="SUPPLY5" gate="G$1" x="132.08" y="124.46" rot="R180"/>
<instance part="SUPPLY6" gate="G$1" x="96.52" y="124.46"/>
<instance part="SUPPLY7" gate="G$1" x="121.92" y="124.46"/>
<instance part="GND4" gate="1" x="129.54" y="154.94"/>
<instance part="BAT1" gate="G$1" x="86.36" y="86.36"/>
<instance part="BAT2" gate="G$1" x="116.84" y="86.36"/>
</instances>
<busses>
</busses>
<nets>
