...
<part name="RENAMED" library="adafruit" deviceset="R-US_" device="R0805" value="10K"/>
...
<sheet>
<plain>
<text x="2.54" y="177.8" size="1.778" layer="91">Works_007_a
Adding Components, Labeling, Moving, Connecting, and Copying.</text>
<text x="2.54" y="172.72" size="1.778" layer="91">This schematic will show you hot to perform various actions with components, then we will make a simple decoupling circuit for power input.</text>
<wire x1="0" y1="170.18" x2="86.36" y2="170.18" width="0.1524" layer="94"/>
<text x="2.54" y="162.56" size="1.778" layer="91">To add a component, on the command line, enter ADD.
Or, you may use F2 key to open up an add window.</text>
<text x="2.54" y="142.24" size="1.778" layer="91">Try for yourself; use add window, search for R0805,
then add a resistor to your schematic.
You can place same components multiple times as well;
simply click multiple times.</text>
<wire x1="86.36" y1="170.18" x2="190.5" y2="170.18" width="0.1524" layer="94"/>
<wire x1="190.5" y1="170.18" x2="248.92" y2="170.18" width="0.1524" layer="94"/>
<wire x1="0" y1="139.7" x2="86.36" y2="139.7" width="0.1524" layer="94"/>
<wire x1="86.36" y1="139.7" x2="86.36" y2="170.18" width="0.1524" layer="94"/>
<text x="88.9" y="160.02" size="1.778" layer="91">There are two labels in a single component; NAME and VALUE.
Use NAME to name a component (such as R1, R2, etc.)
Use VALUE to assign a value to a component.</text>
<text x="88.9" y="142.24" size="1.778" layer="91">To change NAME: Enter NAME on command line, or use F6 key.
To change VALUE: Enter VAL on command line, or use F7 key.
Try for yourself; change NAME to R, then change VALUE to 100k</text>
<wire x1="86.36" y1="139.7" x2="190.5" y2="139.7" width="0.1524" layer="94"/>
<wire x1="190.5" y1="139.7" x2="190.5" y2="170.18" width="0.1524" layer="94"/>
<text x="2.54" y="132.08" size="1.778" layer="91">To move a component, enter MOVE on command line.
Or use F4 key for shortcut.</text>
<text x="2.54" y="119.38" size="1.778" layer="91">Try for yourself; use move command to move R3 
closer to R2</text>
<wire x1="0" y1="116.84" x2="86.36" y2="116.84" width="0.1524" layer="94"/>
<wire x1="86.36" y1="116.84" x2="86.36" y2="139.7" width="0.1524" layer="94"/>
<text x="2.54" y="106.68" size="1.778" layer="91">when moving components, you can use right mouse button
to rotate a component. You can also use middle
mouse button to flip the component.</text>
<text x="2.54" y="78.74" size="1.778" layer="91">Try for yourself;
move and rotate R5 so it is on same horizontal
line as other components.</text>
<wire x1="0" y1="76.2" x2="86.36" y2="76.2" width="0.1524" layer="94"/>
<wire x1="86.36" y1="76.2" x2="86.36" y2="104.14" width="0.1524" layer="94"/>
<text x="88.9" y="132.08" size="1.778" layer="91">To connect two components together, you use NET.
Enter NET on command line, or use F5 on keyboard.</text>
<text x="88.9" y="116.84" size="1.778" layer="91">Click once on starting node, then move your cursor to target
node, then click again.</text>
<text x="88.9" y="106.68" size="1.778" layer="91">Try for yourself; connect VIN to R8, R8 to R9.</text>
<wire x1="86.36" y1="104.14" x2="86.36" y2="116.84" width="0.1524" layer="94"/>
<wire x1="86.36" y1="104.14" x2="190.5" y2="104.14" width="0.1524" layer="94"/>
<wire x1="190.5" y1="104.14" x2="190.5" y2="139.7" width="0.1524" layer="94"/>
<text x="2.54" y="50.8" size="1.778" layer="91">In order to move multiple components at once, you
must group them first.
Enter GROUP on command line, or use F3 key on
keyboard.
Left click and drag area where components are, then
let go of your mouse button.
Your components should be highlighted.
From here, while MOVE command is entered, hold
down CTRL key, then click right mouse button once.</text>
<text x="2.54" y="2.54" size="1.778" layer="91">Try for yourself; group three components,
then move them around!</text>
<wire x1="86.36" y1="76.2" x2="86.36" y2="63.5" width="0.1524" layer="94"/>
<text x="88.9" y="93.98" size="1.778" layer="91">Notice the difference; if two nets are connected, you will see a
temporary node created.
Otherwise, it will overlap each other, without a node.</text>
<text x="111.506" y="87.884" size="1.778" layer="91">&lt;-CONNECTED</text>
<text x="111.506" y="83.058" size="1.778" layer="91">&lt;-CONNECTED</text>
<text x="111.76" y="72.644" size="1.778" layer="91">&lt;-CONNECTED</text>
<text x="111.76" y="77.724" size="1.778" layer="91">&lt;-NOT CONNECTED (OVERLAPPING)</text>
<wire x1="86.36" y1="63.5" x2="86.36" y2="40.64" width="0.1524" layer="94"/>
<wire x1="86.36" y1="40.64" x2="86.36" y2="0" width="0.1524" layer="94"/>
<wire x1="86.36" y1="63.5" x2="190.5" y2="63.5" width="0.1524" layer="94"/>
<wire x1="190.5" y1="63.5" x2="190.5" y2="104.14" width="0.1524" layer="94"/>
<text x="88.9" y="66.04" size="1.778" layer="91">To delete a connected net, use DEL command, or F8 on keyboard.</text>
<wire x1="86.36" y1="40.64" x2="190.5" y2="40.64" width="0.1524" layer="94"/>
<wire x1="190.5" y1="40.64" x2="190.5" y2="63.5" width="0.1524" layer="94"/>
<text x="193.04" y="147.32" size="1.778" layer="91">TRY MAKING A DECOUPLING CIRCUIT.
YOU WILL NEED;
1X VIN NODE
1X CAPACITOR
1X RESISTOR
1X GROUND
(NOTE THAT RESISTOR SIMPLY
REPRESENTS A LOAD ON A CIRCUIT)</text>
<text x="88.9" y="53.34" size="1.778" layer="91">You can copy components instead of adding them every time.
Enter COPY to command window, then click on target component to
copy; a new copy of component will appear.</text>
<text x="193.04" y="109.22" size="1.778" layer="91">Decoupling circuit acts as local
power supply for load, such as
sensor. For example, when 
VIN shows sudden drop (spike),
C1 will use its charges to 
temporarly supply power to 
LOAD, effectively 'bypassing'
the power supply.</text>
</plain>
<instances>
<instance part="FRAME1" gate="G$1" x="0" y="0"/>
<instance part="FRAME1" gate="G$2" x="147.32" y="0"/>
<instance part="R1" gate="G$1" x="7.62" y="154.94"/>
<instance part="RENAMED" gate="G$1" x="93.98" y="154.94"/>
<instance part="SUPPLY1" gate="G$1" x="7.62" y="127" rot="R90"/>
<instance part="R2" gate="G$1" x="15.24" y="127"/>
<instance part="R3" gate="G$1" x="63.5" y="127"/>
<instance part="SUPPLY2" gate="G$1" x="7.62" y="99.06" rot="R90"/>
<instance part="R4" gate="G$1" x="15.24" y="99.06"/>
<instance part="R5" gate="G$1" x="22.86" y="93.98" rot="R90"/>
<instance part="SUPPLY3" gate="G$1" x="124.46" y="127" rot="R90"/>
<instance part="R6" gate="G$1" x="134.62" y="127"/>
<instance part="R7" gate="G$1" x="149.86" y="127"/>
<instance part="SUPPLY4" gate="G$1" x="124.46" y="111.76" rot="R90"/>
<instance part="R8" gate="G$1" x="134.62" y="111.76"/>
<instance part="R9" gate="G$1" x="149.86" y="111.76"/>
<instance part="SUPPLY5" gate="G$1" x="7.62" y="45.72" rot="R90"/>
<instance part="R10" gate="G$1" x="15.24" y="45.72"/>
<instance part="R11" gate="G$1" x="63.5" y="45.72"/>
<instance part="SUPPLY6" gate="G$1" x="93.98" y="88.9" rot="R90"/>
<instance part="R12" gate="G$1" x="104.14" y="88.9"/>
<instance part="SUPPLY7" gate="G$1" x="93.98" y="83.82" rot="R90"/>
<instance part="R14" gate="G$1" x="104.14" y="83.82"/>
<instance part="SUPPLY8" gate="G$1" x="93.98" y="78.74" rot="R90"/>
<instance part="R16" gate="G$1" x="104.14" y="78.74"/>
<instance part="SUPPLY9" gate="G$1" x="93.98" y="73.66" rot="R90"/>
<instance part="R18" gate="G$1" x="104.14" y="73.66"/>
<instance part="R13" gate="G$1" x="96.52" y="45.72"/>
<instance part="SUPPLY10" gate="G$1" x="208.28" y="142.24" rot="R90"/>
<instance part="LOAD" gate="G$1" x="218.44" y="142.24" rot="R180"/>
<instance part="C1" gate="G$1" x="210.82" y="137.16"/>
<instance part="GND1" gate="1" x="228.6" y="137.16"/>
</instances>
<busses>
</busses>
<nets>
