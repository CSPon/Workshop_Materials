...
<sheet>
<plain>
<text x="2.54" y="177.8" size="1.778" layer="91">WORKS_007
ADDING COMPONENTS, LABELING, MOVING, CONNECTING, AND DECOUPLING</text>
<text x="2.54" y="172.72" size="1.778" layer="91">THIS SCHEMATIC WILL SHOW YOU HOW TO PERFORM VARIOUS ACTIONS WITH COMPONENTS, THEN WE WILL MAKE A SIMPLE DECOUPLING CIRCUIT FOR POWER INPUT.</text>
<wire x1="0" y1="170.18" x2="86.36" y2="170.18" width="0.1524" layer="94"/>
<text x="2.54" y="162.56" size="1.778" layer="91">TO ADD A COMPONENT, ON THE COMMAND LINE, TYPE 'ADD'
...
YOU CAN PLACE SAME COMPONENTS MULTIPLE TIMES;
...
USE VALUE TO ASSIGN VALUE TO A COMPONENT</text>
<text x="88.9" y="147.32" size="1.778" layer="91">TO CHANGE NAME: TYPE 'NAME' ON COMMAND LINE, OR USE F6 KEY</text>
<text x="88.9" y="144.78" size="1.778" layer="91">TO CHANGE VALUE: TYPE 'VAL' ON COMMAND LINE, OR USE F7 KEY</text>
<text x="88.9" y="142.24" size="1.778" layer="91">TRY FOR YOURSELF: CHANGE NAME TO R, THEN CHANGE VALUE TO 100K</text>
...
<text x="2.54" y="132.08" size="1.778" layer="91">TO MOVE A COMPONENT, TYPE 'MOVE' ON COMMAND WINDOW.
OR USE F4 KEY FOR SHORTCUT.</text>
<text x="2.54" y="119.38" size="1.778" layer="91">TRY FOR YOURSELF;
USE MOVE COMMAND TO MOVE R3 CLOSER TO R2</text>
...
<text x="2.54" y="106.68" size="1.778" layer="91">WHEN MOVING COMPONENTS, YOU CAN USE RIGHT MOUSE
BUTTON TO ROTATE A COMPONENT. YOU CAN ALSO USE
MIDDLE MOUSE BUTTON TO FLIP THE COMPONENT</text>
...
SIMPLY TYPE 'NET' ON COMMAND WINDOW, OR USE F5 ON KEYBOARD.</text>
<text x="88.9" y="116.84" size="1.778" layer="91">CLICK ONCE ON STARTING NODE, THEN MOVE YOUR CURSOR TO TARGE
NODE, THEN CLICK ONCE.</text>
...
TYPE 'GROUP' ON COMMAND LINE, OR USE F3 KEY ON 
KEYBOARD.
LEFT CLICK AND DRAG AREA WHERE COMPONENTS, ARE, THEN
LET GO OF YOUR MOUSE BUTTON.
YOUR COMPONENTS SHOULD BE HIGHLIGHTED.
FROM THERE, WHILE MOVE COMMAND IS SELECTED, HOLD
DOWN CTRL KEY, THEN CLICK RIGHT MOUSE BUTTON.</text>
<text x="2.54" y="5.08" size="1.778" layer="91">TRY FOR YOURSELF; GROUP THE THREE COMPONENTS,
THEN MOVE THEN AROUND!</text>
...
<wire x1="86.36" y1="63.5" x2="86.36" y2="38.1" width="0.1524" layer="94"/>
<wire x1="86.36" y1="38.1" x2="86.36" y2="0" width="0.1524" layer="94"/>
...
<text x="88.9" y="66.04" size="1.778" layer="91">TO DELETE A CONNECTED NET, USE 'DELETE' COMMAND,
OR F8 ON KEYBOARD.</text>
<text x="88.9" y="53.34" size="1.778" layer="91">YOU CAN ALSO NAME YOUR NET AND LABEL THEM.
TO NAME A NET, USE 'NAME' COMMAND.
TO LABEL A NET, USE 'LABEL' COMMAND.</text>
<text x="88.9" y="40.64" size="1.778" layer="91">TRY FOR YOURSELF; RENAME THE (NET) TO OUTPUT.
OBSERVE WHAT HAPPENS NEXT.</text>
<wire x1="86.36" y1="38.1" x2="190.5" y2="38.1" width="0.1524" layer="94"/>
<wire x1="190.5" y1="38.1" x2="190.5" y2="63.5" width="0.1524" layer="94"/>
...
<instance part="SUPPLY10" gate="G$1" x="93.98" y="48.26" rot="R90"/>
<instance part="R13" gate="G$1" x="104.14" y="48.26"/>
<instance part="GND1" gate="1" x="147.32" y="48.26" rot="R90"/>
</instances>
<busses>
</busses>
<nets>
