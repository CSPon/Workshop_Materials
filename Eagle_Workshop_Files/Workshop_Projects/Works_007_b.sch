...
<part name="C2" library="resistor" library_urn="urn:adsk.eagle:library:348" deviceset="C-US" device="C0805"/>
...
<sheet>
<plain>
<text x="149.86" y="27.94" size="1.778" layer="91">Works_007_b

We will talk about modifying schematics further.</text>
<wire x1="0" y1="165.1" x2="38.1" y2="165.1" width="0.1524" layer="94"/>
<wire x1="38.1" y1="165.1" x2="38.1" y2="185.42" width="0.1524" layer="94"/>
<wire x1="38.1" y1="165.1" x2="71.12" y2="165.1" width="0.1524" layer="94"/>
<wire x1="71.12" y1="165.1" x2="71.12" y2="185.42" width="0.1524" layer="94"/>
<text x="73.66" y="170.18" size="1.778" layer="91">1. There will be a case where you don't have enough space to fit all symbols in certain spaces.
Here, we have voltage regulator circuit along with LED circuit.
Right now, LED circuit on right is not connected to 5V supply. One way to add power supply is
by adding the 5V node symbol to the end of R1. This will automatically connect left side of R1
to positive 5V supply line.</text>
<wire x1="0" y1="114.3" x2="38.1" y2="114.3" width="0.1524" layer="94"/>
<wire x1="38.1" y1="114.3" x2="38.1" y2="165.1" width="0.1524" layer="94"/>
<wire x1="71.12" y1="165.1" x2="71.12" y2="114.3" width="0.1524" layer="94"/>
<wire x1="71.12" y1="114.3" x2="38.1" y2="114.3" width="0.1524" layer="94"/>
<text x="73.66" y="144.78" size="1.778" layer="91">2. For power supplies, since we have power supply symbols, we can easily connect powers via nodes.
But what about signals?
Here, we have dual channel OpAmp trying to send amplified signal to LED. How can we connect signals?
First, we create floating net on each end of R2 and R3. Then, by using NAME command (F6), name each
signals such as SIG1 and SIG2. Do the same to each end of OpAmp output; when you rename floating
net on OpAmps to SIG1 or SIG2, a prompt window will popup, asking if you want to connect selected net
to already-existing net with same name. Click yes, and now we have two floating nets connected remotely!</text>
<wire x1="71.12" y1="165.1" x2="248.92" y2="165.1" width="0.1524" layer="94"/>
<text x="73.66" y="134.62" size="1.778" layer="91">You can also display net's name by using LABEL command.
Enter LABEL to command line, then click on the floating net to display label.
Click again on schematic to place label where cursor is pointing at.</text>
<wire x1="71.12" y1="114.3" x2="248.92" y2="114.3" width="0.1524" layer="94"/>
<text x="40.64" y="104.14" size="1.778" layer="91">3. There will be a case where you want to label two signals with same name, such as switching signals.
To add active low sign; that is, a bar on top of your label, add ! in front of name when adding names.
So for this example, we type (! SIG) for R5, and just (SIG) for R4.</text>
<wire x1="0" y1="96.52" x2="38.1" y2="96.52" width="0.1524" layer="94"/>
<wire x1="38.1" y1="96.52" x2="38.1" y2="114.3" width="0.1524" layer="94"/>
<text x="40.64" y="76.2" size="1.778" layer="91">4. Notice the symbol name for D4 and D5 above; its overlapping each other.
To avoid this, you can detach symbol label by using SMASH command.
Enter SMASH to command line, then click on D7; you will notice a new cross-hair appear on label.
Use MOVE command (F4) to move label around.

Also, to move components/labels/nets/lines/etc with more precision, hold down ALT key while moving
components. This allows coarse adjustment.</text>
<wire x1="38.1" y1="96.52" x2="248.92" y2="96.52" width="0.1524" layer="94"/>
<wire x1="38.1" y1="96.52" x2="38.1" y2="73.66" width="0.1524" layer="94"/>
<wire x1="38.1" y1="73.66" x2="248.92" y2="73.66" width="0.1524" layer="94"/>
<wire x1="38.1" y1="73.66" x2="0" y2="73.66" width="0.1524" layer="94"/>
</plain>
<instances>
<instance part="FRAME1" gate="G$1" x="0" y="0"/>
<instance part="FRAME1" gate="G$2" x="147.32" y="0"/>
<instance part="U1" gate="G$1" x="17.78" y="180.34"/>
<instance part="SUPPLY1" gate="G$1" x="5.08" y="180.34" rot="R90"/>
<instance part="SUPPLY2" gate="G$1" x="33.02" y="180.34" rot="R270"/>
<instance part="C1" gate="G$1" x="7.62" y="175.26"/>
<instance part="C2" gate="G$1" x="27.94" y="175.26"/>
<instance part="GND1" gate="1" x="17.78" y="167.64"/>
<instance part="R1" gate="G$1" x="50.8" y="175.26"/>
<instance part="D1" gate="G$1" x="60.96" y="175.26" rot="MR270"/>
<instance part="GND2" gate="1" x="68.58" y="172.72"/>
<instance part="SUPPLY3" gate="G$1" x="43.18" y="175.26" rot="R90"/>
<instance part="IC1" gate="G1" x="20.32" y="154.94"/>
<instance part="IC1" gate="G2" x="20.32" y="137.16"/>
<instance part="IC1" gate="G3" x="20.32" y="121.92" rot="R90"/>
<instance part="SUPPLY4" gate="G$1" x="7.62" y="121.92" rot="R90"/>
<instance part="GND3" gate="1" x="33.02" y="119.38"/>
<instance part="SUPPLY5" gate="G$1" x="7.62" y="152.4" rot="R90"/>
<instance part="R2" gate="G$1" x="45.72" y="144.78"/>
<instance part="D2" gate="G$1" x="58.42" y="144.78" rot="MR270"/>
<instance part="GND4" gate="1" x="66.04" y="132.08"/>
<instance part="R3" gate="G$1" x="45.72" y="137.16"/>
<instance part="D3" gate="G$1" x="58.42" y="137.16" rot="MR270"/>
<instance part="SUPPLY6" gate="G$1" x="7.62" y="134.62" rot="R90"/>
<instance part="GND5" gate="1" x="5.08" y="139.7" rot="R270"/>
<instance part="GND6" gate="1" x="5.08" y="157.48" rot="R270"/>
<instance part="R4" gate="G$1" x="17.78" y="106.68"/>
<instance part="R5" gate="G$1" x="17.78" y="101.6"/>
<instance part="D4" gate="G$1" x="27.94" y="106.68" rot="MR270"/>
<instance part="D5" gate="G$1" x="27.94" y="101.6" rot="MR270"/>
<instance part="GND7" gate="1" x="35.56" y="99.06"/>
<instance part="R6" gate="G$1" x="17.78" y="88.9"/>
<instance part="R7" gate="G$1" x="17.78" y="83.82"/>
<instance part="D6" gate="G$1" x="27.94" y="88.9" smashed="yes" rot="MR270">
<attribute name="NAME" x="32.512" y="93.345" size="1.778" layer="95" font="vector" rot="MR0"/>
<attribute name="VALUE" x="32.512" y="86.995" size="1.778" layer="96" font="vector" rot="MR0" align="top-left"/>
</instance>
<instance part="D7" gate="G$1" x="27.94" y="83.82" smashed="yes" rot="MR270">
<attribute name="NAME" x="32.258" y="80.137" size="1.778" layer="95" font="vector" rot="MR0"/>
<attribute name="VALUE" x="32.512" y="81.915" size="1.778" layer="96" font="vector" rot="MR0" align="top-left"/>
</instance>
