...
<sheet>
<plain>
<text x="149.86" y="25.4" size="1.778" layer="91">Works_009
We will start talking about AtMega328P and how to wire it
to make it work.</text>
<text x="5.08" y="139.7" size="1.778" layer="91">These are the power related pins.
Connect appropriate power to these
pins to supply power to your microcontroller.</text>
<text x="5.08" y="106.68" size="1.778" layer="91">This is the external clock input pin.
Remember, all CPUs need clock to properly operate.
Faster the clock, faster the instructions are executed.
Although AtMega chips have built-in internal clocks,
they are slow(8Mhz) and inaccurate; which means it
is always good idea to have external clock so the
microcontroller can execute instructions without any
delay.</text>
<text x="20.32" y="157.48" size="1.778" layer="91">This is the hardware reset pin.
Notice the small circle on the pin; this indicates this pin
is active-low pin. Active-low pins are activated by pulling
the pin to ground(GND).</text>
<text x="154.94" y="160.02" size="1.778" layer="91">These are the analog input pins.
Notice the pin 27 and 28, these are the I2C pins.
Which means if these pins are not used as analog input pins,
it works as I2C pins.</text>
<text x="157.48" y="76.2" size="1.778" layer="91">These are the digital input/output pins.
Notice the names in parentheses; those are the secondary
usage pin. For example, pin 17~19 are used to program the
microcontrller when not used. Otherwise, these pins can be
used as regular digitial input/output pins.</text>
<text x="5.08" y="73.66" size="1.778" layer="91">AtMega328P
32KB of Programmable Flash Memory
1KB of EEPROM
2KB of SRAM
...
Up to 20MIPS Throughput at 20MHz</text>
</plain>
<instances>
...
<wire x1="2.54" y1="104.14" x2="88.9" y2="104.14" width="0.1524" layer="91"/>
...
<wire x1="137.16" y1="150.876" x2="111.76" y2="150.876" width="0.1524" layer="91"/>
<wire x1="111.76" y1="150.876" x2="111.76" y2="154.94" width="0.1524" layer="91"/>
...
<wire x1="109.22" y1="154.94" x2="17.78" y2="154.94" width="0.1524" layer="91"/>
<wire x1="17.78" y1="154.94" x2="17.78" y2="170.18" width="0.1524" layer="91"/>
<wire x1="17.78" y1="170.18" x2="109.22" y2="170.18" width="0.1524" layer="91"/>
...
<wire x1="152.4" y1="172.72" x2="248.92" y2="172.72" width="0.1524" layer="91"/>
<wire x1="248.92" y1="172.72" x2="248.92" y2="157.48" width="0.1524" layer="91"/>
<wire x1="248.92" y1="157.48" x2="165.1" y2="157.48" width="0.1524" layer="91"/>
</segment>
</net>
<net name="N$5" class="0">
<segment>
<wire x1="154.94" y1="73.66" x2="246.38" y2="73.66" width="0.1524" layer="91"/>
<wire x1="246.38" y1="73.66" x2="246.38" y2="91.44" width="0.1524" layer="91"/>
<wire x1="246.38" y1="91.44" x2="165.1" y2="91.44" width="0.1524" layer="91"/>
...
<wire x1="165.1" y1="132.08" x2="165.1" y2="91.44" width="0.1524" layer="91"/>
</segment>
</net>
